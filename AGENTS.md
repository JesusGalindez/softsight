...
<!-- generado: puertas -->
`npm run test:agents-md` · `npm run test:bind` · `npm run test:bridge` · `npm run test:bvh` · `npm run test:codes` · `npm run test:determinism` · `npm run test:geometry` · `npm run test:glb-writer` · `npm run test:model-cache` · `npm run test:rig` · `npm run test:story` · `npm run test:summary` · `npm run test:text` · `npm run test:text-plan` · `npm run test:worker`
<!-- /generado: puertas -->
...
ruta. En CI eso significa que el verde cubre tipos, determinismo y 10 de 15 puertas.
