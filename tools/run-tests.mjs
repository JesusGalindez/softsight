...
const GATES = [
  ...
  "report-r7.test.mjs", // 4,0 s de CPU — R7: el informe de máquina y el de persona
  "confidence.test.mjs", // 3,5 s de CPU — R6: desde dónde se miró, no solo si se miró
  ...
  "budgets.test.mjs", // 2,4 s de CPU — R9: los presupuestos del paquete, evaluados contra lo medido
  ...
  "colmap.test.mjs" /* 4,4 s de CPU con el fixture real presente; 0,1 s sin él */, // 0,3 s — el adaptador de COLMAP contra las observaciones del propio fichero
